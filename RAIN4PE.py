# -*- coding: utf-8 -*-
"""
Created on Fri Aug 19 19:12:57 2022

@author: Jonatan Moreno
        'Esfuerzate y se valiente.....Josué 1:9'
"""
#*****************************************************************************************#
...
seasonal_mean.pcp.plot(col='month', robust= True, cmap='jet',col_wrap=4)
...
for i, season in enumerate(('DJF','MAM','JJA', 'SON')):
    ...
    o= axes[0,i].contourf(long_day, lat_day,seas_pp['variable'].sel(season=season),
                          transform=projection,cmap='jet',hatches=['/'])##### hatches=['//']
...
plt.xlabel("Date")
plt.ylabel("")
df_f.to_csv("D:/Qswat_cachi/Jonatan_tesis/Scenarios/Simulacion_Python/RAIN4PE/RAIN4PE_Cachi.csv", index=True)
